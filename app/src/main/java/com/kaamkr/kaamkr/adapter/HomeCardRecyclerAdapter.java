...
public class HomeCardRecyclerAdapter extends RecyclerView.Adapter<HomeCardRecyclerAdapter.ItemRowHolder>{

    private ArrayList<SectionDataModel> dataList;
    private Context mContext;

    public HomeCardRecyclerAdapter(Context context, ArrayList<SectionDataModel> dataList) {
